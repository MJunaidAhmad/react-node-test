        ...
        const productsData = [
            {
                ...
                price: 199.99,
                category: 'fitness',
                imageUrl: 'https://placehold.co/400x400/6366f1/ffffff?text=Premium+Training+Program',
                stock: 50,
                featured: true,
            },
            {
                ...
                price: 49.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/10b981/ffffff?text=Nutrition+Guide+Book',
                stock: 100,
                featured: true,
            },
            {
                ...
                price: 79.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/ef4444/ffffff?text=Resistance+Bands+Set',
                stock: 30,
                featured: false,
            },
            {
                ...
                price: 29.99,
                category: 'apparel',
                imageUrl: 'https://placehold.co/400x400/f59e0b/ffffff?text=Athletic+T-Shirt',
                stock: 75,
                featured: false,
            },
            {
                ...
                price: 89.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/8b5cf6/ffffff?text=Recovery+Supplement+Bundle',
                stock: 40,
                featured: true,
            },
            {
                ...
                price: 299.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/ec4899/ffffff?text=Adjustable+Dumbbells',
                stock: 15,
                featured: false,
            },
            {
                ...
                price: 59.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/14b8a6/ffffff?text=Yoga+Mat+Premium',
                stock: 60,
                featured: false,
            },
            {
                ...
                price: 149.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/06b6d4/ffffff?text=Kettlebell+Set',
                stock: 25,
                featured: true,
            },
            {
                ...
                price: 39.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/f97316/ffffff?text=Pre-Workout+Energy',
                stock: 80,
                featured: false,
            },
            {
                ...
                price: 69.99,
                category: 'apparel',
                imageUrl: 'https://placehold.co/400x400/a855f7/ffffff?text=Compression+Leggings',
                stock: 45,
                featured: false,
            },
            {
                ...
                price: 49.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/3b82f6/ffffff?text=Pull-Up+Bar',
                stock: 35,
                featured: false,
            },
            {
                ...
                price: 499.99,
                category: 'fitness',
                imageUrl: 'https://placehold.co/400x400/6366f1/ffffff?text=Online+Coaching',
                stock: 20,
                featured: true,
            },
            {
                ...
                price: 24.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/10b981/ffffff?text=Protein+Bars',
                stock: 120,
                featured: false,
            },
            {
                ...
                price: 19.99,
                category: 'apparel',
                imageUrl: 'https://placehold.co/400x400/f59e0b/ffffff?text=Workout+Gloves',
                stock: 90,
                featured: false,
            },
            {
                ...
                price: 34.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/ef4444/ffffff?text=Foam+Roller',
                stock: 55,
                featured: false,
            },
            {
                ...
                price: 29.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/8b5cf6/ffffff?text=Meal+Prep+Containers',
                stock: 70,
                featured: false,
            },
            {
                ...
                price: 44.99,
                category: 'apparel',
                imageUrl: 'https://placehold.co/400x400/ec4899/ffffff?text=Running+Shorts',
                stock: 50,
                featured: false,
            },
            {
                ...
                price: 89.99,
                category: 'equipment',
                imageUrl: 'https://placehold.co/400x400/14b8a6/ffffff?text=Battle+Rope',
                stock: 20,
                featured: false,
            },
            {
                ...
                price: 24.99,
                category: 'nutrition',
                imageUrl: 'https://placehold.co/400x400/06b6d4/ffffff?text=Creatine',
                stock: 95,
                featured: false,
            },
            {
                ...
                price: 54.99,
                category: 'apparel',
                imageUrl: 'https://placehold.co/400x400/f97316/ffffff?text=Hooded+Sweatshirt',
                stock: 40,
                featured: false,
            },
        ];
